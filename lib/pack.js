...
_Object$defineProperty(exports, "getSsrLib", {
  enumerable: true,
  get: function get() {
    return _lib.getSsrLib;
  }
});

_Object$defineProperty(exports, "injectHtmlToRootNode", {
  enumerable: true,
  get: function get() {
    return _lib.injectHtmlToRootNode;
  }
});

exports.pack = exports.run = exports.getConfig = void 0;
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context5; _forEachInstanceProperty2(_context5 = ownKeys(Object(source), true)).call(_context5, function (key) { (0, _defineProperty2["default"])(target, key, source[key]); }); } else if (_Object$getOwnPropertyDescriptors) { _Object$defineProperties(target, _Object$getOwnPropertyDescriptors(source)); } else { var _context6; _forEachInstanceProperty2(_context6 = ownKeys(Object(source))).call(_context6, function (key) { _Object$defineProperty(target, key, _Object$getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var getConfig = function getConfig() {
  ...
  var target = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'web';
  ...
  var plugins = [new _cleanWebpackPlugin.CleanWebpackPlugin(), new _webpack["default"].DefinePlugin({
    __dev__: isDev
  ...
  if (!isNodeTarget) {
    ...
    plugins.push.apply(plugins, (0, _toConsumableArray2["default"])(htmlsPlugins));
  }
  ...
  var config = {
    ...
    module: {
      rules: (0, _concat["default"])(_context = [{
        test: /\.[j|t]sx?$/,
      ...
      }, getAssetConfig('fonts'))]).call(_context, styleLoaders)
    },
    resolve: {
...
var runWebpack = function runWebpack(config) {
  ...
  if (isDev) {
    ...
    devServer.listen(p, serverConfig.host, function (err) {
      ...
      var serveUrl = (0, _concat["default"])(_context2 = "http://localhost:".concat(p, "/")).call(_context2, openFile, ".html");
...
function nodeApi(isDev, config) {
  var callback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function () {};
  var _ref = config,
      entry = _ref.entry,
      _ref$devServer = _ref.devServer,
      devServer = _ref$devServer === void 0 ? {} : _ref$devServer,
      others = (0, _objectWithoutProperties2["default"])(_ref, ["entry", "devServer"]);

  if ((0, _typeof2["default"])(entry) === 'object' && entry) {
    var keys = (0, _keys["default"])(entry);

    if (keys.length) {
      var _config = getConfig(isDev, entry);

      var mergedConfig = (0, _webpackMerge["default"])({}, _config, others);
